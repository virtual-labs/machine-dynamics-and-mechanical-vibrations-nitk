        ...
        function changescreen(){
            ...
            randomize();
            let quest1 = `Find natural frequency ωn(rad/s) from ωd and ζ`;
        ...
        function checkans(){
            ...
            let resultimg = document.getElementById("resultimg");
            if(ans.toFixed(2)==natfreqans.toFixed(2)){
	...
	let damptxt = document.getElementById('damptxt');
	damptxt.innerHTML = " " + dampingratio
