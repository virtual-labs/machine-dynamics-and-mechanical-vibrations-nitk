...
var quizJSON = {
    ...
    "questions": [
            ...
            "q": "At resonance, for underdamped system increasing the value of damping would lead to ?",
            "a": [
                {"option": "decrease in steady state amplitude",               "correct": true},
                {"option": "increase in steady state amplitude",   "correct": false},
                {"option": "increase then decrease in steady state amplitude",      "correct": false},
                {"option": "decrease then increase in steady state amplitude",     "correct": false} // no comma here
            ],
            "select_any": true,
            "correct": "<p><span>Right answer</span></p>",
            "incorrect": "<p><span>wrong</span><br>Correct Answer is : decrease in steady state amplitude</p>" // no comma here
        },
       { // Question 2 - Multiple Choice, Multiple True Answers, Select All
            "q": " A system with 10kg mass 10N/m stiffness and 2.5Ns/m damping is being operated at 1rad/s if X<sub>st</sub>=1cm what is the value of X<sub>0</sub> ?",
            "a": [
...
{ // Question 5
            "q": "Amplification factor of a system was found to be 2 at resonance. What would be its damping ratio? ",
            "a": [
...
// no comma here
            ...
            "correct": "<p><span>Right answer</span></p>",
            "incorrect": "<p><span>wrong</span><br>Correct Answer Is : 0.25</p>"  // no comma here
        }
