...
RUN mkdir /machine-dynamics-and-mechanical-vibrations-nitk

COPY src/ /machine-dynamics-and-mechanical-vibrations-nitk/src

WORKDIR ./machine-dynamics-and-mechanical-vibrations-nitk/src
